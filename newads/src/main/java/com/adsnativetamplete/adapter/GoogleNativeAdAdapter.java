...
//GoogleNativeAdAdapter googleAdapter = GoogleNativeAdAdapter.Builder.with(getActivity(), AdsUtils.nativeId,mVoiceAdapter).adItemInterval(getResources().getInteger(R.integer.nativeRange)).build();
