...
import com.dingo.germanforkids.databinding.ActivityFindThePicBinding;
...
public class FindThePic extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImageView imgFalseOrTrueView;
    private ImageView imgNext;
    private RelativeLayout lnWordAndImage;
    ...
    ActivityFindThePicBinding binding;
    ...
    public void onCreate(Bundle bundle) {
        ...
        binding = ActivityFindThePicBinding.inflate(getLayoutInflater());
        ...
        YoYo.with(Techniques.RubberBand).duration(1200).repeat(1).playOn(binding.img1);
        YoYo.with(Techniques.RubberBand).duration(1200).repeat(1).playOn(binding.img2);
        YoYo.with(Techniques.RubberBand).duration(1200).repeat(1).playOn(binding.img3);
        YoYo.with(Techniques.RubberBand).duration(1200).repeat(1).playOn(binding.imgView);
    ...
    private void initComponents() {
        ...
        imgFalseOrTrue1 = (ImageView) findViewById(R.id.imgFalseOrTrue1);
        imgFalseOrTrue2 = (ImageView) findViewById(R.id.imgFalseOrTrue2);
        imgFalseOrTrue3 = (ImageView) findViewById(R.id.imgFalseOrTrue3);
        imgFalseOrTrueView = (ImageView) findViewById(R.id.imgFalseOrTrueView);
        ...
        lnWordAndImage = (RelativeLayout) findViewById(R.id.lnWordAndImage);
    ...
    public void addItems() {
        ...
        for (int i = 0; i < imagesList.size(); i++) {
            if (!imagesList.get(i).equals(imagesList.get(position))) {
                wrongAnswers.add(imagesList.get(i));
            }
        }
        Collections.shuffle(wrongAnswers);
        allAnswers.add(imagesList.get(position));
        for (int i2 = 0; i2 < 3; i2++) {
            allAnswers.add(wrongAnswers.get(i2));
        }
        Collections.shuffle(allAnswers);
        img1.setImageResource(allAnswers.get(0).intValue());
        img1.setTag(allAnswers.get(0));
        img2.setImageResource(allAnswers.get(1).intValue());
        img2.setTag(allAnswers.get(1));
        img3.setImageResource(allAnswers.get(2).intValue());
        img3.setTag(allAnswers.get(2));
        imgView.setImageResource(allAnswers.get(3).intValue());
        imgView.setTag(allAnswers.get(3));
    ...
    public void answer(View view) {
        ...
        switch (view.getId()) {
            case R.id.rl1:
                checkAnswer(img1, imgFalseOrTrue1, rl1);
                return;
            case R.id.rl2:
                checkAnswer(img2, imgFalseOrTrue2, rl2);
                return;
            case R.id.rl3:
                checkAnswer(img3, imgFalseOrTrue3, rl3);
                return;
            case R.id.rlView:
                checkAnswer(imgView, imgFalseOrTrueView, rlView);
                return;
            default:
                return;
        }
    ...
    private void checkAnswer(ImageView imageView, ImageView imageView2, RelativeLayout relativeLayout) {
        ...
        if (imageView.getTag() == imagesList.get(position)) {
    ...
    public void next(View view) {
        ...
        if (position == wordsList.size() - 1) {
            ...
            addItems();
            speak(soundsList.get(position).intValue());
            YoYo.with(Techniques.ZoomIn).duration(500L).repeat(0).playOn(lnWordAndImage);
            YoYo.with(Techniques.ZoomIn).duration(500L).repeat(0).playOn(rl1);
            YoYo.with(Techniques.ZoomIn).duration(500L).repeat(0).playOn(rl2);
            YoYo.with(Techniques.ZoomIn).duration(500L).repeat(0).playOn(rl3);
            YoYo.with(Techniques.ZoomIn).duration(500L).repeat(0).playOn(rlView);
        ...
        imgFalseOrTrue1.setVisibility(View.GONE);
        imgFalseOrTrue2.setVisibility(View.GONE);
        imgFalseOrTrue3.setVisibility(View.GONE);
        imgFalseOrTrueView.setVisibility(View.GONE);
    }
